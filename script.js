...
const translations = {
  ...
  fr: {
    ...
    'nav.process': 'Installation',
    'nav.cta': 'Télécharger',
    'language.label': 'Langue',
    'hero.eyebrow': 'Mod pour Generals Zero Hour',
    'hero.title': 'Télécharger Middle East Conflict 3',
    'hero.description': 'Le meilleur mod arabe pour Generals Zero Hour avec de nouvelles cartes, des factions équilibrées et des unités uniques.',
    'hero.bullet1': 'Contenu arabe complet',
    'hero.bullet2': 'Compatibilité totale avec Zero Hour',
    'hero.bullet3': 'Installation facile',
    'hero.primary': 'Télécharger le Mod',
    'hero.secondary': 'Voir les fonctionnalités',
    'hero.cardTag': 'Mod Arabe',
    'hero.screenTitle': 'Nouvelles cartes et unités',
    'hero.screenDescription': 'Une nouvelle expérience de combat avec des batailles au Moyen-Orient et des améliorations.',
    'hero.featureTag1': 'Cartes Arabes',
    'hero.featureTag2': 'Nouvelles Unités',
    'hero.featureTag3': 'Équilibrage',
    'hero.stat1.value': '15+',
    'hero.stat1.label': 'Nouvelles Cartes',
    'hero.stat2.value': '8',
    'hero.stat2.label': 'Factions',
    'hero.stat3.value': '100%',
    'hero.stat3.label': 'Compatible',
    'preview.title': 'Aperçu du Mod',
    'preview.desc': 'MEC3 reconstruit l\'expérience Generals avec du contenu original.',
    'preview.feature1.title': 'Factions Uniques',
    'preview.feature1.desc': 'Nouvelles unités comme les blindés légers et l\'artillerie du désert.',
    'preview.feature2.title': 'Cartes de Combat',
    'preview.feature2.desc': 'Cartes conçues pour le combat urbain et les bases avancées.',
    'preview.feature3.title': 'Mises à jour d\'équilibrage',
    'preview.feature3.desc': 'Amélioration des capacités pour des batailles justes et rapides.',
    'features.title': 'Fonctionnalités de MEC 3',
    'features.desc': 'Téléchargement gratuit du meilleur mod.',
    'features.feature1.title': 'Nouvelles Cartes',
    'features.feature1.desc': 'Cartes arabes équilibrées pour différentes batailles.',
    'features.feature2.title': 'Unités Avancées',
    'features.feature2.desc': 'Nouvelles unités avec un style moyen-oriental.',
    'features.feature3.title': 'Équilibre de Jeu',
    'features.feature3.desc': 'Ajustements pour des escarmouches justes.',
    'release.title': 'Notes de version',
    'release.desc': 'Toutes les versions avec les dernières fonctionnalités.',
    'process.title': 'Étapes d\'installation',
    'process.desc': 'Suivez ces étapes simples.',
    'process.step1.title': 'Télécharger le mod',
    'process.step1.desc': 'Cliquez pour obtenir l\'archive du mod.',
    'process.step2.title': 'Extraire les fichiers',
    'process.step2.desc': 'Ouvrez l\'archive et déplacez les fichiers dans le dossier du jeu.',
    'process.step3.title': 'Jouer',
    'process.step3.desc': 'Lancez le jeu et profitez.',
    'cta.title': 'Télécharger Middle East Conflict 3 Maintenant',
    'cta.desc': 'Quelques clics et vous êtes prêt.',
    'cta.button': 'Télécharger le Mod',
    'footer.text': 'Mod Middle East Conflict 3 pour Generals Zero Hour.',
    'footer.email': 'support@example.com',
    'langModal.title': 'Choisissez votre langue',
    'langModal.subtitle': 'Votre choix sera mémorisé pour vos prochaines visites.'
  },
  es: {
    brand: 'Middle East Conflict 3',
    'nav.features': 'Características',
    'nav.releases': 'Notas de la versión',
    'nav.process': 'Instalación',
    'nav.cta': 'Descargar',
    'language.label': 'Idioma',
    'hero.eyebrow': 'Mod para Generals Zero Hour',
    'hero.title': 'Descargar Middle East Conflict 3',
    'hero.description': 'El mejor mod árabe para Generals Zero Hour con nuevos mapas, facciones equilibradas y unidades únicas.',
    'hero.bullet1': 'Contenido árabe completo',
    'hero.bullet2': 'Compatibilidad total con Zero Hour',
    'hero.bullet3': 'Fácil instalación',
    'hero.primary': 'Descargar Mod',
    'hero.secondary': 'Ver características',
    'hero.cardTag': 'Mod Árabe',
    'hero.screenTitle': 'Nuevos mapas y unidades',
    'hero.screenDescription': 'Una nueva experiencia de combate con batallas en Oriente Medio.',
    'hero.featureTag1': 'Mapas Árabes',
    'hero.featureTag2': 'Nuevas Unidades',
    'hero.featureTag3': 'Equilibrio',
    'hero.stat1.value': '15+',
    'hero.stat1.label': 'Nuevos Mapas',
    'hero.stat2.value': '8',
    'hero.stat2.label': 'Facciones',
    'hero.stat3.value': '100%',
    'hero.stat3.label': 'Compatible',
    'preview.title': 'Vista previa',
    'preview.desc': 'MEC3 reconstruye la experiencia de Generals.',
    'preview.feature1.title': 'Facciones Únicas',
    'preview.feature1.desc': 'Nuevas unidades como blindados ligeros.',
    'preview.feature2.title': 'Mapas de Combate',
    'preview.feature2.desc': 'Mapas diseñados para combate urbano.',
    'preview.feature3.title': 'Actualizaciones',
    'preview.feature3.desc': 'Mejora de habilidades para batallas justas.',
    'features.title': 'Características',
    'features.desc': 'Descarga gratuita del mejor mod.',
    'features.feature1.title': 'Nuevos Mapas',
    'features.feature1.desc': 'Mapas árabes equilibrados.',
    'features.feature2.title': 'Unidades Avanzadas',
    'features.feature2.desc': 'Nuevas unidades con estilo.',
    'features.feature3.title': 'Equilibrio',
    'features.feature3.desc': 'Ajustes para escaramuzas justas.',
    'release.title': 'Notas de versión',
    'release.desc': 'Todas las versiones con las últimas funciones.',
    'process.title': 'Pasos de instalación',
    'process.desc': 'Siga estos sencillos pasos.',
    'process.step1.title': 'Descargar',
    'process.step1.desc': 'Haga clic para obtener el mod.',
    'process.step2.title': 'Extraer',
    'process.step2.desc': 'Mueva los archivos a la carpeta del juego.',
    'process.step3.title': 'Jugar',
    'process.step3.desc': 'Inicie el juego y disfrute.',
    'cta.title': 'Descargar Middle East Conflict 3',
    'cta.desc': 'Pocos clics y estás listo.',
    'cta.button': 'Descargar Mod',
    'footer.text': 'Mod Middle East Conflict 3 para Generals Zero Hour.',
    'footer.email': 'support@example.com',
    'langModal.title': 'Elige tu idioma',
    'langModal.subtitle': 'Tu elección será recordada.'
  }
};
  ...
  ar: [
    {
      ...
      bullets: [
        ...
        'تم حل مشكلة استمرار وتكرار صوت فيديو المقدمة في الخلفية عند بدء تشغيل اللعبة.',
        'إصلاح مشكلة إعادة تعيين بيانات الملف الشخصي (المستوى والرتبة) عند تغيير كلمة المرور.'
      ]
    },
    {
      version: '3.5.2.4',
  ...
  fr: [
    {
      ...
      bullets: [
        'Quitter automatiquement les autres réseaux lors du changement de serveur.',
        'Définir l\'adaptateur ZeroTier sur Privé.',
        'Création automatique de règles de pare-feu.',
        'Démarrage silencieux du service ZeroTier.',
      ]
    },
    {
      version: '3.5.1.2',
      ...
      date: 'Avril 2026',
      title: 'Gestion automatique du dossier MEC 3',
      bullets: [
        'Création automatique du dossier MEC 3.',
        'Téléchargement des mises à jour directement dans MEC 3.',
      ]
    }
  ],
  es: [
    {
      ...
      bullets: [
        'Abandonar redes automáticamente al cambiar de servidor.',
        'Configurar el adaptador ZeroTier como Privado.',
        'Crear reglas de firewall automáticamente.',
        'Iniciar el servicio ZeroTier de forma silenciosa.',
      ]
    },
    {
      version: '3.5.1.2',
      badge: 'Gestión de rutas',
      date: 'Abril 2026',
      title: 'Manejo automático de la carpeta MEC 3',
      bullets: [
        'Crear automáticamente la carpeta MEC 3.',
        'Descargar actualizaciones directamente en MEC 3.',
      ]
    }
  ]
};
