...
const translations = {
  ar: {
    ...
    'process.step2.title': 'فك الضغط',
    'process.step2.desc': 'افتح الملف وانقل محتوى المود إلى مجلد اللعبة.',
    'process.step3.title': 'ابدأ اللعب',
    'process.step3.desc': 'شغّل Generals Zero Hour واستمتع بالخرائط والوحدات الجديدة.',
